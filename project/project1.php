...
<html lang="en">
    ...
    <head>
        <title>COMP1950 Web Dev 2:Home</title>
        <meta charset="utf-8">
        ...
        <main class="container-fluid text-center">
            <div class="row content">
                <article class="col-sm-9 text-left">
                    <section class="well">
                        <h3>Welcome to Applied Web Development Level 2</h3>
                    ...
                    <section class="well" id="sectionlist">
                        ...
                        <ul>
                            ...
                            <li>Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget.
                            </li>
                ...
                <nav class="col-sm-2 sidenav">
                    <section class="well">
                        ...
                        <p><a href="mailto:jeffrey_parker@bcit.ca">Jeff Parker</a>
                            <br/><span id="email">(jeffrey_parker@bcit.ca)</span></p>
                        <p><a href="mailto:michael_whyte@bcit.ca">Michael Whyte</a> <br /> <span id="email">(michael_whyte@bcit.ca)</span></p>
                    </section>
                </nav>
            </div>
        </main>
